              ...
              <tbody>
                {brands.length > 0 ? brands.map((brand, index) => (
                  <tr key={brand.id}>
                    ...
                    <td>
                      <span className={`badge ${brand.status_name === 'Active' ? 'bg-success' : 'bg-secondary'}`}>
                        {brand.status_name}
                      </span>
                    </td>
                    <td className="text-center">
                      <NavLink to={`/brands/edit/${brand.id}`} className="btn btn-warning btn-sm me-2">
                        Edit
                      </NavLink>
